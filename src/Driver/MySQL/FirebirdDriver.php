...
namespace IST\DoctrineFirebirdDriver\Driver\MySQL;
...
final class FirebirdDriver implements \Doctrine\DBAL\Driver, \Doctrine\DBAL\Driver\ExceptionConverterDriver, \Doctrine\DBAL\VersionAwarePlatformDriver
{
    /**
     * {@inheritdoc}
     */
    public function connect(array $params, $username = null, $password = null, array $driverOptions = [])
    {
        try {
            $conn = new PDO\Connection(
                'firebird:dbname=' . $params['host'] . '/' . $params['port'] . ':' . $params['dbname'],
                $username,
                $password,
                $driverOptions
            );
